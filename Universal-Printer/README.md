...
This template simply tracks your toner/ink levels via SNMP, and a simple ping to your device, with "low" and "critical" alerts.
...
## Setup
1. Download `Universal-Printer-Supply-Levels-by-SNMP`.
